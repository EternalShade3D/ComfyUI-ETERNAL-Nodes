...
NODE_CLASS_MAPPINGS = {**NODE_CLASS_MAPPINGS, **_FLAT_MAP, **_BRIDGE_MAP, **_F3D_MAP, **_AR_MAP, "EternalPreview3D": EternalPreview3D}
NODE_DISPLAY_NAME_MAPPINGS = {**NODE_DISPLAY_NAME_MAPPINGS, **_FLAT_NAMES, **_BRIDGE_NAMES, **_F3D_NAMES, **_AR_NAMES, "EternalPreview3D": "Preview 3D Eternal"}
