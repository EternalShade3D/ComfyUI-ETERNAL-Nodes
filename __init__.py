...
NODE_CLASS_MAPPINGS = {**NODE_CLASS_MAPPINGS, **_FLAT_MAP, **_BRIDGE_MAP, **_F3D_MAP, **_AR_MAP}
NODE_DISPLAY_NAME_MAPPINGS = {**NODE_DISPLAY_NAME_MAPPINGS, **_FLAT_NAMES, **_BRIDGE_NAMES, **_F3D_NAMES, **_AR_NAMES}
